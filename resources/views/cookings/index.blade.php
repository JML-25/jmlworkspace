...
<div>
	...
	<!-- Le tableau pour lister les articles/cookings -->
			...
			<div class=" border-y hover:bg-green-100 bg-amber-50 flex items-center justify-between">
				...
				<div class="p-3 px-5">
					...
					<a href="{{ route('cookings.edit', $cooking) }}" class="mr-3 text-sm bg-blue-500 hover:bg-blue-700 text-white py-1 px-2 rounded focus:outline-none focus:shadow-outline">Modifier</a>
	...
	<div class="border-y pb-5">
		...
		{{-- {{ $cookings->links('vendor.pagination.bootstrap-5')}} --}}
	</div>
